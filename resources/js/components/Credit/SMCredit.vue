                    ...
                    <div class="card-body table-responsive">
                            ...
                            <table class="table table-hover table-bordered table-striped table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <a href="#" @click.prevent="updateSorting('credit_date')">Credit Date</a>
                                        ...
                                        <th>
                                            <a href="#" @click.prevent="updateSorting('credit_amount')">Credit
                                                Amount</a>
                                ...
                                <tbody>
                                    <tr v-for="detail in details.data" v-bind:key="detail.credit_id">
                                        <td>
                                            {{ detail.credit_id }}
                                        </td>
                                        <td>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-6 offset-5">
                                <pagination :data="details" @pagination-change-page="getAllCreditDetails"></pagination>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="creditId == -1 ? 0 : 1" class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <button type="button" class="btn btn-tool" @click="closeEditCredit">
    ...
    export default {
        ...
        methods: {
            ...
            updateDetailsSaveUpdate: function () {
                if(this.creditDate == "" || this.creditDesc == "" || this.creditAmount == "") {
