                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="form-group" style="display: flex; flex-direction: row">
                      ...
                      <div class="col-md-3">
                        <input type="date" class="form-control" v-model="date" placeholder="Enter Inward Date..." />
                      </div>
                      ...
                      <div class="col-md-3">
                        <model-select :options="companyNames" @blur="getFromSelectedCompany"
                          v-model="selectedCompanyName" placeholder="Select Company Name...">
                        </model-select>
                      </div>
                    </div>
                    <div class="form-group" style="display: flex; flex-direction: row">
                      ...
                      <div class="col-md-3">
                        <input type="text" class="form-control" v-model="mobileNo" placeholder="Mobile No..."
                          disabled />
                      </div>
                    </div>
                    <div class="form-group" style="display: flex; flex-direction: row">
                      ...
                      <div class="col-md-3">
                        <model-select :options="brokers" v-model="selectedBroker" placeholder="Select Broker Name..">
                        </model-select>
                      </div>
                    </div>
                    <div class="form-group" style="display: flex; flex-direction: row">
                      ...
                      <div class="col-md-3">
                        <model-select :options="productQualityCategories" @blur="loadFromSelectedCategory"
                          v-model="selectedProductQualityCategory" placeholder="Select Product Category...">
                        </model-select>
                      </div>
                      <div class="col-md-1"></div>
                      <div class="col-md-2">
                    ...
                    <div class="form-group" style="display: flex; flex-direction: row">
                      ...
                      <div class="col-md-3">
                        <select class="form-select form-control" id="gstPercentage" v-model="gstPercentage">
                  ...
                  <div class="card-footer">
                    <button type="submit" v-on:click="addInward" class="btn btn-primary">
                      Add
                    </button>
                    <button type="reset" v-on:click="resetInwardDetails" class="btn btn-primary">
                      Reset
                    </button>
                  </div>
                </div>
