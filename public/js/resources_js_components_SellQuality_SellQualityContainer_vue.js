(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_SellQuality_SellQualityContainer_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadQualityCategories: function loadQualityCategories() {
      var _this = this;

      axios.get('../api/sellqualitycategories').then(function (response) {
        _this.qualityCategories = response.data.qualityCategories.map(function (category) {
          return {
    ...
    addSellQuality: function addSellQuality() {
      var _this2 = this;
      ...
      if (this.selectedQualityCategory == '' || this.qualityName == '') {
        ...
        axios.post("../api/sellquality/insert", addData).then(function (res) {
          if (res.data.status == -1) {
            var errormsg = res.data.errors;

            try {
              if (errormsg.qualityName) toastr__WEBPACK_IMPORTED_MODULE_0___default().error(errormsg.qualityName);
            } catch (err) {}

            try {
              if (errormsg.qualityCategoryId) toastr__WEBPACK_IMPORTED_MODULE_0___default().error(errormsg.qualityCategoryId);
            } catch (err) {}
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              _this2.$emit("refreshSellQualityTable");
            });
          }
        })["catch"](function (err) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SMSellQuality.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SMSellQuality.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getAllSellQualities: function getAllSellQualities() {
      var _this = this;

      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      axios.get("../api/sellqualities?page=" + page + "&paginate=" + this.paginate + "&search=" + this.search + "&sortdirection=" + this.sort_direction + "&sortfield=" + this.sort_field).then(function (response, err) {
        if (err) {}

        _this.sellqualities = response.data;
      });
    },
    ...
    editSellQuality: function editSellQuality(sell_quality_id, sell_quality_category_id, sell_category_name, quality_name) {
    ...
    loadQualityCategories: function loadQualityCategories() {
      ...
      axios.get('../api/sellqualitycategories').then(function (response) {
        _this2.qualityCategories = response.data.qualityCategories.map(function (category) {
          return {
            value: category.qualityCategoryId,
            text: category.qualityCategoryName
          };
    ...
    updateSellQuality: function updateSellQuality() {
      var _this3 = this;

      if (this.selectedQualityCategory == '' || this.editQualityName == '') {
        toastr__WEBPACK_IMPORTED_MODULE_0___default().error('All Fields are Required');
      } else {
        axios.put('../api/sellquality/update/' + this.sellQualityId, {
          ...
          if (res.data.status == -1) {
            ...
            try {
              if (errormsg.editQualityName) toastr__WEBPACK_IMPORTED_MODULE_0___default().error(errormsg.editQualityName);
            } catch (err) {}

            try {
              if (errormsg.editQualityCategoryId) toastr__WEBPACK_IMPORTED_MODULE_0___default().error(errormsg.editQualityCategoryId);
            } catch (err) {}
          } else if (res.data.status == 0) {
            toastr__WEBPACK_IMPORTED_MODULE_0___default().warning(res.data.message);
          } else if (res.data.status == 1) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
              ...
              _this3.sellQualityId = -1;

              _this3.getAllSellQualities(_this3.sellqualities.current_page);
            });
          }
        })["catch"](function (err) {
    ...
    deleteSellQuality: function deleteSellQuality(sell_quality_id) {
      var _this4 = this;

      axios["delete"]('../api/sellquality/delete/' + sell_quality_id).then(function (res) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
          title: "Success",
          html: "<h5 style='color:#9C9794'>Sell Quality Deleted Successfully</h5>",
          icon: "success"
        }).then(function (result) {
          _this4.getAllSellQualities(_this4.sellqualities.current_page);
        });
      })["catch"](function (err) {
        console.log(err.res.data.message);
        toastr__WEBPACK_IMPORTED_MODULE_0___default().error('Something went Wrong.');
    ...
    closeEditSellQuality: function closeEditSellQuality() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SellQualityContainer.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SellQualityContainer.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _NewSellQuality__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NewSellQuality */ "./resources/js/components/SellQuality/NewSellQuality.vue");
/* harmony import */ var _SMSellQuality__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SMSellQuality */ "./resources/js/components/SellQuality/SMSellQuality.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "SellQualityContainer",
  components: {
    NewSellQuality: _NewSellQuality__WEBPACK_IMPORTED_MODULE_0__.default,
    SMSellQuality: _SMSellQuality__WEBPACK_IMPORTED_MODULE_1__.default
  },
  methods: {
    refreshSellQualityTable: function refreshSellQualityTable(event) {
      this.$refs.form.getAllSellQualities();
    }
  }
});
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=style&index=0&id=01f8dbda&scoped=true&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=style&index=0&id=01f8dbda&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NewSellQuality_vue_vue_type_style_index_0_id_01f8dbda_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NewSellQuality.vue?vue&type=style&index=0&id=01f8dbda&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=style&index=0&id=01f8dbda&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_NewSellQuality_vue_vue_type_style_index_0_id_01f8dbda_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/***/ "./resources/js/components/SellQuality/NewSellQuality.vue":
/*!****************************************************************!*\
  !*** ./resources/js/components/SellQuality/NewSellQuality.vue ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _NewSellQuality_vue_vue_type_template_id_01f8dbda_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NewSellQuality.vue?vue&type=template&id=01f8dbda&scoped=true& */ "./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=template&id=01f8dbda&scoped=true&");
/* harmony import */ var _NewSellQuality_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./NewSellQuality.vue?vue&type=script&lang=js& */ "./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=script&lang=js&");
/* harmony import */ var _NewSellQuality_vue_vue_type_style_index_0_id_01f8dbda_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./NewSellQuality.vue?vue&type=style&index=0&id=01f8dbda&scoped=true&lang=css& */ "./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=style&index=0&id=01f8dbda&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  _NewSellQuality_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _NewSellQuality_vue_vue_type_template_id_01f8dbda_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _NewSellQuality_vue_vue_type_template_id_01f8dbda_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "01f8dbda",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/SellQuality/NewSellQuality.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/SellQuality/SMSellQuality.vue":
/*!***************************************************************!*\
  !*** ./resources/js/components/SellQuality/SMSellQuality.vue ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _SMSellQuality_vue_vue_type_template_id_8ba8a614___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SMSellQuality.vue?vue&type=template&id=8ba8a614& */ "./resources/js/components/SellQuality/SMSellQuality.vue?vue&type=template&id=8ba8a614&");
/* harmony import */ var _SMSellQuality_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SMSellQuality.vue?vue&type=script&lang=js& */ "./resources/js/components/SellQuality/SMSellQuality.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _SMSellQuality_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _SMSellQuality_vue_vue_type_template_id_8ba8a614___WEBPACK_IMPORTED_MODULE_0__.render,
  _SMSellQuality_vue_vue_type_template_id_8ba8a614___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/SellQuality/SMSellQuality.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components
*/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SMSellQuality.vue?vue&type=template&id=8ba8a614&");


/***/ }),

/***/ "./resources/js/components/SellQuality/SellQualityContainer.vue?vue&type=template&id=299d7ac1&":
/*!*****************************************************************************************************!*\
  !*** ./resources/js/components/SellQuality/SellQualityContainer.vue?vue&type=template&id=299d7ac1& ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SellQualityContainer_vue_vue_type_template_id_299d7ac1___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SellQualityContainer_vue_vue_type_template_id_299d7ac1___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SellQualityContainer_vue_vue_type_template_id_299d7ac1___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SellQualityContainer.vue?vue&type=template&id=299d7ac1& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SellQualityContainer.vue?vue&type=template&id=299d7ac1&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=template&id=01f8dbda&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/NewSellQuality.vue?vue&type=template&id=01f8dbda&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            _c("div", { staticClass: "form-group row" }, [
              ...
              _c(
                ...
                [
                  _c("model-select", {
                    attrs: {
                      options: _vm.qualityCategories,
                      placeholder: "Select Quality Category"
                    },
                    model: {
                      value: _vm.selectedQualityCategory,
                      callback: function($$v) {
                        _vm.selectedQualityCategory = $$v
                      },
                      expression: "selectedQualityCategory"
                    }
                  })
                ],
                1
            ...
            _c("div", { staticClass: "form-group row" }, [
              ...
              _c("div", { staticClass: "col-md-4" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.qualityName,
                      expression: "qualityName"
                    }
                  ],
                  ...
                  domProps: { value: _vm.qualityName },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.qualityName = $event.target.value
                    }
                  }
                })
              ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("h3", { staticClass: "card-title" }, [_vm._v("New Sell Quality")]),
      _vm._v(" "),
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-md-2" }, [
      _c(
        "label",
        {
          staticClass: "text-md col-form-label",
          attrs: { for: "qualitycategory" }
        },
        [
          _vm._v("Quality Category "),
          _c(
            "span",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SMSellQuality.vue?vue&type=template&id=8ba8a614&":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SMSellQuality.vue?vue&type=template&id=8ba8a614& ***!
  \*************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c("div", { staticClass: "card-body table-responsive" }, [
              ...
              [
                ...
                _c("div", { staticClass: "col-md-4" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control ",
                    attrs: { type: "search", placeholder: "Search By ..." },
              ...
              _c(
                ...
                [
                  _c("thead", { staticClass: "text-md" }, [
                    _c("tr", [
                      _c("th", { attrs: { width: "10%" } }, [
                          ...
                          "a",
                          {
                            ...
                            on: {
                              click: function($event) {
                                ...
                                return _vm.updateSorting("sell_quality_id")
                              }
                            }
                          },
                          [_vm._v("Sr. No.")]
                        ...
                        _vm._v(" "),
                        (_vm.sort_field == "sell_quality_id"
                        ? 1
                        : 0)
                          ? _c("span", [
                        ...
                        _c(
                          "a",
                          {
                            ...
                            on: {
                              click: function($event) {
                                $event.preventDefault()
                                return _vm.updateSorting("quality_name")
                              }
                            }
                          },
                          [_vm._v("Quality Name")]
                      ...
                      _c("th", [
                        _c(
                          "a",
                          {
                            ...
                            on: {
                              click: function($event) {
                                $event.preventDefault()
                                return _vm.updateSorting("sell_category_name")
                              }
                            }
                          },
                          [_vm._v("Category")]
                        ...
                        _vm._v(" "),
                        (_vm.sort_field == "sell_category_name"
                        ? 1
                        : 0)
                          ? _c("span", [
                              (_vm.sort_direction == "asc"
                  ...
                  _c(
                    "tbody",
                    { staticClass: "text-md" },
                    _vm._l(_vm.sellqualities.data, function(sellquality) {
                      return _c("tr", { key: sellquality.sell_quality_id }, [
                        _c("td", [_vm._v(_vm._s(sellquality.sell_quality_id))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(sellquality.quality_name))]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(sellquality.sell_category_name))
                        ]),
                        _vm._v(" "),
                        _c("td", { staticClass: "text-center" }, [
                          _c(
                            "button",
                            {
                              staticClass: "btn btn-primary btn-sm text-md",
                              on: {
                                click: function($event) {
                                  return _vm.editSellQuality(
                                    sellquality.sell_quality_id,
                                    sellquality.sell_quality_category_id,
                                    sellquality.sell_category_name,
                                    sellquality.quality_name
                                  )
                                }
                              }
                            },
                          ...
                          _c(
                            "button",
                            {
                              staticClass: "btn btn-danger btn-sm text-md ml-3",
                              on: {
                                click: function($event) {
                                  return _vm.deleteSellQuality(
                                    sellquality.sell_quality_id
                                  )
                                }
                              }
            ...
            _c("div", { staticClass: "row mt-4" }, [
              _c(
                ...
                [
                  _c("pagination", {
                    attrs: { data: _vm.sellqualities },
                    on: { "pagination-change-page": _vm.getAllSellQualities }
                  })
                ],
                1
              )
                ...
                _c("div", { staticClass: "card-tools" }, [
                  ...
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-tool",
                      attrs: { type: "button" },
                      on: { click: _vm.closeEditSellQuality }
                    },
                ...
                _c("div", { staticClass: "form-group row" }, [
                  ...
                  _c("div", { staticClass: "col-md-4" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editQualityName,
                          expression: "editQualityName"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.editQualityName },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.editQualityName = $event.target.value
                        }
                      }
                    })
                  ])
              ...
              _c("div", { staticClass: "card-footer" }, [
                _c(
                  "button",
                  {
                    staticClass: "btn btn-primary text-md",
                    attrs: { type: "submit" },
                    on: { click: _vm.updateSellQuality }
                  },
                  [_vm._v("Update")]
                ),
                _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SellQualityContainer.vue?vue&type=template&id=299d7ac1&":
/*!********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/SellQuality/SellQualityContainer.vue?vue&type=template&id=299d7ac1& ***!
  \********************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    _c("div", { staticClass: "content-wrapper" }, [
      _c("section", { staticClass: "content" }, [
        _c(
          ...
          [
            _c("NewSellQuality", {
              on: { refreshSellQualityTable: _vm.refreshSellQualityTable }
            }),
            _vm._v(" "),
            _c("SMSellQuality", { ref: "form" })
          ],
          1
        )
      ])
